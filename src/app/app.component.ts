...
import { AcessoLoginClientUsecase } from "./core/acesso/services/acesso-login-client.usecase"; // AuthMasterService não é mais necessário aqui
...
export class AppComponent {
  ...
  constructor(
    ...
    effect(
      () => {
        let userClient =
          localStorage.getItem("userClient") ?? this._loginClient.userClient();
